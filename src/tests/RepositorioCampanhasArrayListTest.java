...
class RepositorioCampanhasArrayListTest {
    ...
    void setUp() {
        ...
        cTeste_1 = new Campanha(new Narrador("Pedro", 20, "123"), "Aventura 1", "Uma aventura aí", "12/12/2025","ABERTA", 2);
        cTeste_2 = new Campanha(new Narrador("Pedro", 25, "123"), "Aventura 2", "Uma aventura aí pt 2", "12/12/2026", "ABERTA", 2);
    }
