...
class RepositorioCampanhasArquivoTest {
    ...
    static void setUp() {
        ...
        campanhaTeste = new Campanha(new Narrador("Pedro", 20, "123"), "Aventura 1", "Uma aventura aí", "12/12/2025","Ativa", 4);
    }
    ...
    void testAtualizar() {
        repositorio.adicionar(campanhaTeste);
        Campanha novaCampanha = new Campanha(new Narrador("Pedro", 25, "123"), "Aventura 2", "Uma aventura aí pt 2", "12/12/2026", "Inativa", 4);
